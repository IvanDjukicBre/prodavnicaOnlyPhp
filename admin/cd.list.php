...
$sql = "SELECT ProductID as id, ProductCategoryID , ProductName as ime , ProductPrice as cena , ProductCartDesc as opis, ProductThumb as slicica FROM products WHERE ProductCategoryID=1";
$result = $conn->query($sql);
?>
<div class="container bggif">
    <div class="bgyellow" >
        <h1>Lista svih CD-a</h1>
        <hr/>
        <table class="table">
            <thead>
            <tr>
